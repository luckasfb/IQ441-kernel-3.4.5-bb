...
//gionee chenqiang 20120120 add for  CR00504809 begin
// LuckAs add
#define GN_MTK_BSP_FLASHLIGHT_SGM3141
// LuckAs end

#ifdef GN_MTK_BSP_FLASHLIGHT_SGM3141
#include <cust_gpio_usage.h>
#endif
//gionee chenqiang 20120120 add for  CR00504809 end
/******************************************************************************
 * Definition
******************************************************************************/
#ifndef TRUE
...
*/
//gionee chenqiang add for CR00705966 20121009 begin
#ifdef GN_MTK_BSP_PMIC_FLASHLIGHT_NEW_MAP
static const MUINT32 strobeLevelLUT[32] = {15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15}; 
#else
...
#endif
//gionee chenqiang add for CR00705966 20121009 end
/*****************************************************************************
Functions
*****************************************************************************/
#if 0
...
#endif
// change
#define GPIO_CAMERA_FLASH_MODE GPIO161
...
#define GPIO_CAMERA_FLASH_EN_PIN GPIO162
#endif
// change
#define GPIO_CAMERA_FLASH_EN GPIO162
...
#elif 1
//gionee chenqiang 20120120 add for  CR00504809 begin
  #if  (defined(GN_MTK_BSP_FLASHLIGHT_SGM3141) || defined(GN_MTK_BSP_FLASHLIGHT_ENABLE))
